...
$sql2 = "SELECT * FROM experience ORDER BY eid DESC LIMIT 1;";
$sql3 = "SELECT * FROM education ORDER BY eid DESC LIMIT 1;";
...
if ($result->num_rows > 0) {
   ...
   if ($result2->num_rows > 0) {
    $experience = $result2->fetch_assoc();
   
   }
   if ($result3->num_rows > 0) {
    $education = $result3->fetch_assoc();
   
   }
if ($result4->num_rows > 0) {
 $skill = $result4->fetch_assoc();
...
<head>
    ...
    <link rel="shortcut icon" href="resume1/favicon.ico">  
    <!-- Google Font -->
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,500,400italic,300italic,300,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
    <!-- FontAwesome JS-->
	<script defer src="resume1/assets/fontawesome/js/all.min.js"></script>
    <!-- Global CSS -->
    <link rel="stylesheet" href="resume1/assets/plugins/bootstrap/css/bootstrap.min.css">   
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="resume1/assets/css/orbit-1.css">
</head> 
    ...
    <div class="wrapper mt-lg-5">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                ...
                <h1 class="name"><?php echo $personalinfo['fname'];?> <?php echo $personalinfo['lname'];?></h1>
                <h3 class="tagline"><?php echo $experience['jobtitle'];?></h3>
            </div><!--//profile-container-->
            
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa-solid fa-envelope"></i><a href="mailto: yourname@email.com"><?php echo $personalinfo['email'];?></a></li>
                    <li class="phone"><i class="fa-solid fa-phone"></i><a href="tel:0123 456 789"><?php echo $personalinfo['phoneno'];?></a></li>
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    ...
                    <h5 class="meta"><?php echo $education['sname'];?></h5>
	                    <div class="time"><?php echo $education['sddate'];?> - <?php echo $education['eddate'];?></div>
                </div><!--//item-->
                <div class="item">
                    <h4 class="degree"><?php echo $education['edegree'];?> in <?php echo $education['fstudy'];?></h4>
                    <h5 class="meta"><?php echo $education['sname'];?></h5>
        ...
        <div class="main-wrapper">
            ...
            <section class="section summary-section">
                ...
                <div class="summary">
                    <p><?php echo $summaries['summary'];?></p>
                </div><!--//summary-->
            </section><!--//section-->
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            ...
                            <div class="time"><?php echo $experience['startdate'];?> - <?php echo $experience['enddate'];?></div>
                        </div><!--//upper-row-->
                        <div class="company"><?php echo $experience['companyname'];?></div>
                        <div class="company"><?php echo $experience['excity'];?></div>
                    </div><!--//meta-->
                    <div class="details">
